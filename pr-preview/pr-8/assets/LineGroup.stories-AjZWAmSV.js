...
}`,...(O=(F=o.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};const J=["単発の台詞","同一話者の連続台詞_名前は先頭のみ","要確認を含む","ナレーション_話者なし","選択肢","複数行の発話が3回連続","複数カード_別話者"];export{J as __namedExportsOrder,I as default,a as ナレーション_話者なし,n as 単発の台詞,r as 同一話者の連続台詞_名前は先頭のみ,o as 複数カード_別話者,s as 複数行の発話が3回連続,t as 要確認を含む,p as 選択肢};
