 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A=e=>{for(const t in e)if(t.startsWith("aria-")||t==="role"||t==="title")return!0;return!1},E=o.createContext({}),I=()=>o.useContext(E),N=o.forwardRef(({color:e,size:t,strokeWidth:r,absoluteStrokeWidth:n,className:c="",children:s,iconNode:h,...u},f)=>{const{size:l=24,strokeWidth:p=2,absoluteStrokeWidth:_=!1,color:k="currentColor",className:C=""}=I()??{},v=n??_?Number(r??p)*24/Number(t??l):r??p;return o.createElement("svg",{ref:f,...d,width:t??l??d.width,height:t??l??d.height,stroke:e??k,strokeWidth:v,className:x("lucide",C,c),...!s&&!A(u)&&{"aria-hidden":"true"},...u},[...h.map(([y,b])=>o.createElement(y,b)),...Array.isArray(s)?s:[s]])});/**
 * @license lucide-react v1.23.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=(e,t)=>{const r=o.forwardRef(({className:n,...c},s)=>o.createElement(N,{ref:s,iconNode:t,className:x(`lucide-${W(m(e))}`,`lucide-${e}`,n),...c}));return r.displayName=m(e),r};/**
 * @license lucide-react v1.23.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]],T=R("info",S),V="_text_1n7ww_9",$="_end_1n7ww_8",q="_plain_1n7ww_37",U="_review_1n7ww_50",z="_mark_1n7ww_59",a={text:V,end:$,plain:q,review:U,mark:z},w="発話が間違っているかもしれません。";function B({line:e,plain:t,align:r="start"}){return i.jsxs("div",{className:g(a.text,t&&a.plain,r==="end"&&a.end,e.needs_review&&a.review),children:[i.jsx(L,{text:e.text}),e.needs_review&&i.jsx("span",{className:a.mark,tabIndex:0,"aria-label":w,title:w,children:i.jsx(T,{size:13,strokeWidth:2.5})})]})}B.__docgenInfo={description:`台詞本文 1 行（話者名はグループ先頭で SpeakerLabel が表示するのでここでは扱わない）。
