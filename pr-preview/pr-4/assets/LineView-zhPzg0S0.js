 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A=e=>{for(const t in e)if(t.startsWith("aria-")||t==="role"||t==="title")return!0;return!1},E=n.createContext({}),I=()=>n.useContext(E),N=n.forwardRef(({color:e,size:t,strokeWidth:r,absoluteStrokeWidth:o,className:c="",children:s,iconNode:f,...p},_)=>{const{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:w=!1,color:k="currentColor",className:y=""}=I()??{},C=o??w?Number(r??u)*24/Number(t??l):r??u;return n.createElement("svg",{ref:_,...d,width:t??l??d.width,height:t??l??d.height,stroke:e??k,strokeWidth:C,className:h("lucide",y,c),...!s&&!A(p)&&{"aria-hidden":"true"},...p},[...f.map(([v,b])=>n.createElement(v,b)),...Array.isArray(s)?s:[s]])});/**
 * @license lucide-react v1.23.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
